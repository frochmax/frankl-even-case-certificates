...
OPENNESS PROVENANCE for Frankl's Conjecture 1.7 (=Yang-Zhang Conj 1.4), even case, at (n,t,k)=(9,3,2); r=(n-t)/2=3.
Status: OPEN as of 2026-07-09.
- Frankl, European J. Combin. 93 (2021) Paper 103279:
...
- Cross-check Yang-Zhang, arXiv:2607.03026 (v1, 3 Jul 2026): refutes only the ODD-parity BLP conjecture; even case untouched.
...
OPENNESS PROVENANCE for Frankl's Conjecture 1.7 (=Yang-Zhang Conj 1.4), even case, at (n,t,k)=(9,3,3); r=(n-t)/2=3.
Status: OPEN as of 2026-07-09.
- Frankl, European J. Combin. 93 (2021) Paper 103279:
